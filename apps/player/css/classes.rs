...
/* #364 bytes(5040..5071)
class!(flex flex_col w_64 my_2)
 */
Class ::
from(vec!
[String :: from(flex), String :: from(flex_col), String :: from(w_64), String
:: from(my_2)]),
